...
class AuthRepository {
  ...
  final GoogleSignIn _googleSignIn = GoogleSignIn(
    serverClientId:
        '999471022250-vukep0886fvkvptlrjqb8vkgambhddup.apps.googleusercontent.com',
  );
  ...
  Future<Map<String, dynamic>?> signInWithKakao() async {
    try {
      ...
      if (await kakao.isKakaoTalkInstalled()) {
        print(
          '[KAKAO_LOGIN] Step 2: KakaoTalk installed. Attempting Talk Login...',
        );
        try {
      ...
      try {
        ...
        print(
          '[KAKAO_LOGIN] Step 4: Login failed ($e). Attempting to create account.',
        );
        try {
          ...
          print(
            '[KAKAO_LOGIN] Step 5: Create failed ($e2). Final attempt login.',
          );
          try {
            userCredential = await _auth.signInWithEmailAndPassword(
              email: email,
            ...
            print(
              '[KAKAO_LOGIN] [CRITICAL_ERROR] Final attempt also failed: $e3',
            );
            rethrow;
          }
        }
      ...
      if (firebaseUser != null) {
        try {
          ...
          return {'user': updatedUser, 'nickname': nickname};
        } catch (e) {
          print('[KAKAO_LOGIN] Profile update error: $e');
          return {'user': firebaseUser, 'nickname': nickname};
        }
      }
      return null;
    } catch (e) {
